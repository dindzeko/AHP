...
class AHPApp:
    ...
    def initialize_gui(self):
        ...
        **Instruksi:**
        ...
        num_criteria = st.number_input("Jumlah Kriteria", min_value=2, value=2, step=1)
        ...
        if "criteria_names" in st.session_state:
            self.criteria_list = []
        ...
        if "criteria_list" in st.session_state:
